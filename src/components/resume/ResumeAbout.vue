...
<template>
        ...
        <section class="mb-12 rounded-lg bg-[#f4f4f4] py-8 px-4">
                <h2 class="text-3xl font-bold mb-4 text-center">
                        <span style="color: #444440; letter-spacing: 0.1em">MOHAMMAD ASAD </span
                        ><span style="color: #828206; letter-spacing: 0.1em">ATTERKHAN</span>
                </h2>
                <!-- contacts -->
                <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 text-sm">
                        <p>
                                <a
